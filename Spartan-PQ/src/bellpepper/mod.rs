...
pub mod r1cs;
/// Bellpepper constraint-system for building R1CS shapes.
pub mod shape_cs;
pub mod solver;
pub mod test_r1cs;
/// Tests and helpers for Bellpepper R1CS shapes.
...
mod tests {
  use crate::{
    ...
    provider::PallasGreyhoundEngine,
    traits::Engine,
  };
  ...
  #[test]
  fn test_alloc_bit() {
    test_alloc_bit_with::<PallasGreyhoundEngine>();
  }
  ...
  fn test_multiround_bits() {
    test_multiround_bits_with::<PallasGreyhoundEngine>();
  }
  ...
  fn test_multiround_permutation() {
    test_multiround_permutation_with::<PallasGreyhoundEngine>();
  }
}
