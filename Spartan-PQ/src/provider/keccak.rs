...
mod tests {
  use crate::{
    provider::{PallasGreyhoundEngine, VestaGreyhoundEngine, keccak::Keccak256Transcript},
    traits::{
      Engine, PrimeFieldExt,
      transcript::{TranscriptEngineTrait, TranscriptReprTrait},
    },
  ...
  fn test_keccak_transcript() {
    test_keccak_transcript_with::<PallasGreyhoundEngine>(
  ...
  fn test_keccak_transcript_incremental_vs_explicit() {
    test_keccak_transcript_incremental_vs_explicit_with::<PallasGreyhoundEngine>();
    test_keccak_transcript_incremental_vs_explicit_with::<VestaGreyhoundEngine>();
  }
}
